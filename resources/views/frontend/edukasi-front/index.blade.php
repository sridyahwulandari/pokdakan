...
<br>
    ...
    <section id="blog" class="blog">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          @foreach ($edukasi as $key => $row)
          <div class="col-lg-8 entries">

            <article class="entry">

              <div class="entry-img">
                <img src="{{ asset('uploads/'. $row->gambar_edukasi)}}" alt="" class="img-fluid">
              </div>

              <h2 class="entry-title">
                <a href="">{{ $row->judul_edukasi }}</a>
              </h2>
              ...
              <div class="entry-content">
                <div class="read-more">
                  <a href="{{ route('edukasi-front-detail', $row->slug)}}">Baca Selengkapnya</a>
                </div>
              </div>
            ...
            <div class="sidebar">
              ...
              <div class="sidebar-item recent-posts">
                <div class="post-item clearfix">
                  <img src="{{ asset('uploads/'. $row->gambar_edukasi)}}" alt="">
                  <h4><a href="blog-single.html">{{ $row->judul_edukasi }}</a></h4>
