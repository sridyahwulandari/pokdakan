    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="{{ Request::is('produk-front*') ? 'active font-bold' : ''}}" href="/produk-front">Produk</a></li>
          <li><a class="{{ Request::is('tentang-kami*') ? 'active font-bold' : ''}}" href="/tentang-kami">Trend Pasar</a></li>
