...
class HistoriController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('histori.create', compact('event', 'pengepul'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($request->produk_terjual < 0){
            return redirect()->route('histori.index')->with(['success' => 'Data gagal Disimpan,input produk terjual tidak boleh kurang dari 1']);
